...
Here lies the main difference between bits and qubits: whereas in classical computation only $0$ and $1$ states are allowed, in quantum computation also superposition states are perfectly acceptable.% \marginpar{Main difference between bits and qubits.} 
...
The simplest case is a system $N=2$ with two qubits $Q_1$ and $Q_2$. If we define the basis of $\mathcal{H}_{Q_1}$ and $\mathcal{H}_{Q_2}$ as $\{\ket{0}_1, \ket{1}_1\}$ and $\{\ket{0}_2, \ket{1}_2\}$ the basis of $H_{QR}$ is %\marginpar{Quantum register with two qubits.}
...
%\marginpar{An example of a separable state.}
\begin{align*}
...
If instead we have:
%\marginpar{An example of an entangled state.}
\begin{equation*}
