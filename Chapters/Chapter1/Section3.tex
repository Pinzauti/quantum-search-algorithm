...
\begin{equation*}
   \ket{Q}_\textup{out} = \hat{G}_1\ket{Q}_\textup{in} = e^{-iH_Q \tau_{G_1}/\hbar}\ket{Q}_\textup{in}\,.
\end{equation*}
\begin{figure}
\centering
...
\begin{equation*}
   \ket{QR}_\textup{out} = \hat{G}_2\ket{QR}_\textup{in} = e^{-iH_{QR} \tau_{G_2}/\hbar}\ket{QR}_\textup{in}
\end{equation*}
