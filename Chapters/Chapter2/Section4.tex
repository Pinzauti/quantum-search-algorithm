...
\end{equation}
times rotates $\ket{\psi}$ to within an angle $\theta/2 \leq \pi/4$ of $\ket{\beta}$. According to~\ref{eq:beta-projection} we can see that observation of the state in the computational basis yields a solution with a probability at least $1/2$. 
